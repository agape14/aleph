<div id="documentosForm">
    ...
    <div id="documentosProgenitor1">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-6">
                <input type="file" id="boletasPagoProgenitor1" name="boletasPagoProgenitor1" class="form-control" accept=".pdf">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-6">
                <input type="file" id="declaracionJuradaProgenitor1" name="declaracionJuradaProgenitor1" class="form-control" accept=".pdf">
                <div class="form-check mt-2">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-6">
                <input type="file" id="certificadoMovimientosProgenitor1" name="certificadoMovimientosProgenitor1" class="form-control" accept=".pdf">
                <div class="form-check mt-2">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-6">
                <input type="file" id="constanciaBusquedaRegistrosProgenitor1" name="constanciaBusquedaRegistrosProgenitor1" class="form-control" accept=".pdf">
                <div class="form-check mt-2">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-6">
                <input type="file" id="otrosDocumentosProgenitor1" name="otrosDocumentosProgenitor1" class="form-control" accept=".pdf">
                <div class="form-check mt-2">
    ...
    <div id="documentosProgenitor2" class="d-none">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-6">
                <input type="file" id="boletasPagoProgenitor2" name="boletasPagoProgenitor2" class="form-control" accept=".pdf">
                <div class="form-check mt-2">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-6">
                <input type="file" id="declaracionJuradaProgenitor2" name="declaracionJuradaProgenitor2" class="form-control" accept=".pdf">
                <div class="form-check mt-2">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-6">
                <input type="file" id="certificadoMovimientosProgenitor2" name="certificadoMovimientosProgenitor2" class="form-control" accept=".pdf">
                <div class="form-check mt-2">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-6">
                <input type="file" id="constanciaBusquedaRegistrosProgenitor2" name="constanciaBusquedaRegistrosProgenitor2" class="form-control" accept=".pdf">
                <div class="form-check mt-2">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-6">
                <input type="file" id="otrosDocumentosProgenitor2" name="otrosDocumentosProgenitor2" class="form-control" accept=".pdf">
                <div class="form-check mt-2">
