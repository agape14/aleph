<div id="validacionpaso6">
    ...
    <div id="documentosProgenitor1">
        <h4 class="mt-4">Archivos del Progenitor 1</h4>
        <div class="row mb-3">
            ...
            <div class="col-sm-6">
                <input type="file" id="boletasPagoProgenitor1" name="boletasPagoProgenitor1" class="form-control" accept=".pdf, image/jpeg" data-name="Boletas Pago Progenitor1">
                ...
                <div class="form-check mt-2">
                    <input class="form-check-input" type="checkbox" id="noAplicaBoletasPagoProgenitor1" name="noAplicaBoletasPagoProgenitor1" >
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-6">
                <input type="file" id="declaracionJuradaProgenitor1" name="declaracionJuradaProgenitor1" class="form-control" accept=".pdf, image/jpeg" data-name="Declaracion Jurada Progenitor1">
                <small id="fileHelp" class="text-muted">Adjuntar archivo en formato <strong>PDF</strong> o <strong>JPG</strong>. El tamaño máximo de <strong>5MB</strong>. </small>
                <div class="form-check mt-2">
                    <input class="form-check-input" type="checkbox" id="noAplicaDeclaracionJuradaProgenitor1" name="noAplicaDeclaracionJuradaProgenitor1">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-6">
                <input type="file" id="constanciaBusquedaRegistrosProgenitor1" name="constanciaBusquedaRegistrosProgenitor1" class="form-control" accept=".pdf, image/jpeg" data-name="Constancia Busqueda Progenitor1">
                <small id="fileHelp" class="text-muted">Adjuntar archivo en formato <strong>PDF</strong> o <strong>JPG</strong>. El tamaño máximo de <strong>5MB</strong>. </small>
                <div class="form-check mt-2">
                    <input class="form-check-input" type="checkbox" id="noAplicaConstanciaBusquedaRegistrosProgenitor1" name="noAplicaConstanciaBusquedaRegistrosProgenitor1">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-6">
                <input type="file" id="otrosDocumentosProgenitor1" name="otrosDocumentosProgenitor1" class="form-control" accept=".pdf, image/jpeg" data-name="Otros Documentos Progenitor1">
                <small id="fileHelp" class="text-muted">Adjuntar archivo en formato <strong>PDF</strong> o <strong>JPG</strong>. El tamaño máximo de <strong>5MB</strong>. </small>
                <div class="form-check mt-2">
                    <input class="form-check-input" type="checkbox" id="noAplicaOtrosDocumentosProgenitor1" name="noAplicaOtrosDocumentosProgenitor1">
    ...
    <div id="documentosProgenitor2" class="d-none">
        <h4 class="mt-4">Archivos del Progenitor 2</h4>
        <div class="row mb-3">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-6">
                <input type="file" id="declaracionJuradaProgenitor2" name="declaracionJuradaProgenitor2" class="form-control" accept=".pdf, image/jpeg" data-name="Declaracion Jurada Progenitor2">
                <small id="fileHelp" class="text-muted">Adjuntar archivo en formato <strong>PDF</strong> o <strong>JPG</strong>. El tamaño máximo de <strong>5MB</strong>. </small>
                <div class="form-check mt-2">
                    <input class="form-check-input" type="checkbox" id="noAplicaDeclaracionJuradaProgenitor2" name="noAplicaDeclaracionJuradaProgenitor2">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-6">
                <input type="file" id="constanciaBusquedaRegistrosProgenitor2" name="constanciaBusquedaRegistrosProgenitor2" class="form-control" accept=".pdf, image/jpeg" data-name="Constancia Busqueda Registros Progenitor2">
                <small id="fileHelp" class="text-muted">Adjuntar archivo en formato <strong>PDF</strong> o <strong>JPG</strong>. El tamaño máximo de <strong>5MB</strong>. </small>
                <div class="form-check mt-2">
                    <input class="form-check-input" type="checkbox" id="noAplicaConstanciaBusquedaRegistrosProgenitor2" name="noAplicaConstanciaBusquedaRegistrosProgenitor2">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-6">
                <input type="file" id="otrosDocumentosProgenitor2" name="otrosDocumentosProgenitor2" class="form-control" accept=".pdf, image/jpeg" data-name="Otros Documentos Progenitor2">
                <small id="fileHelp" class="text-muted">Adjuntar archivo en formato <strong>PDF</strong> o <strong>JPG</strong>.</small>
                <div class="form-check mt-2">
                    <input class="form-check-input" type="checkbox" id="noAplicaOtrosDocumentosProgenitor2" name="noAplicaOtrosDocumentosProgenitor2">
